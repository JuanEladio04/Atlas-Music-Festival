...
<body class="bg-cBackground">
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-lg w-full p-8 bg-cPrimary shadow-md rounded-md text-center">
            <h1 class="text-4xl font-bold color-cAccent mb-4">Error 503</h1>
            <p class="text-xl text-white mb-8">Lo sentimos, el servicio no está disponible en este momento.</p>
